...
const { createPonto, listPontos, getPontoById, updatePonto, deletePonto, getDetalhes } = require('../controllers/pontoController');
...
router.get('/:id/detalhes', requireAuth, getDetalhes);
